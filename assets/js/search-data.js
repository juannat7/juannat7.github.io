...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-deep-koopman-operators-for-causal-discovery-is-accepted-to-communications-physics",
          title: 'Deep Koopman operators for causal discovery is accepted to Communications Physics.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/juan-nathaniel-872234b8", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
